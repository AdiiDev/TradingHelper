...
import { setLayouts, setShowLayout } from '../services/config/LayoutsConfigSlice'
    ...
    <WrapperBasicPage>
      ...
      <div style={{ minHeight: '80vh', width: '100%' }}>
        ...
        <div className={hide ? "test-hide" : ""}>
          <ChartGrid settings={baseSettings} selectedLayout={selectedLayout} currentWidgetsArray={currentWidgetsArray} setCurrentWidgetsArray={setCurrentWidgetsArray} />
